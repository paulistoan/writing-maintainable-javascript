    ...
    function AdapterPattern(el) {
        this.render = function () {
            ...
            var classes = {
              ...
              abstractFactory: new uml.Interface({
                position: {
                    x: 350,
                    y: 10
                },
...
/*
            var classes = {
                ...
                address: new uml.Class({
                    ...
                    name: 'Address',
                    attributes: ['houseNumber: Integer',
                        'streetName: String',
                        'town: String',
                        'postcode: String'
                    ],
